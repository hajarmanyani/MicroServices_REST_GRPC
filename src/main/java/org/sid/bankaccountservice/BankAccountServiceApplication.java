...
public class BankAccountServiceApplication {
	...
	@Bean
	CommandLineRunner start(bankAccountRepository bnkAccountRepository, CustomerRepository customerRepository){
		return args -> {
			Stream.of("hajar","rachad","youssef","mehdi").forEach(c->{
